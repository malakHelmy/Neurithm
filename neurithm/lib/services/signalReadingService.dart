...
class SignalReadingService {
  ...
  Future<void> uploadFileAndStartThinking(BuildContext context,
      {bool isNewWord = false}) async {
    const String localServerUrl = 'https://f5cf-197-161-60-5.ngrok-free.app/start_thinking';
  ...
  Future<void> doneThinking(BuildContext context) async {
    try {
      var response = await http.post(
        Uri.parse(
            'https://f5cf-197-161-60-5.ngrok-free.app/done_thinking'), 
      );
  ...
  Future<void> restartServer(BuildContext context) async {
    try {
      var response = await http.post(
        Uri.parse('https://f5cf-197-161-60-5.ngrok-free.app/restart'), // Restart endpoint
      );
