...
class SignalReadingService {
  ...
  Future<void> uploadFileAndStartThinking(BuildContext context,
      {bool isNewWord = false}) async {
    const String localServerUrl = 'https://62c5-45-243-241-52.ngrok-free.app/start_thinking';
  ...
  Future<void> doneThinking(BuildContext context) async {
    try {
      var response = await http.post(
        Uri.parse(
            'https://62c5-45-243-241-52.ngrok-free.app/done_thinking'), 
      );
  ...
  Future<void> restartServer(BuildContext context) async {
    try {
      var response = await http.post(
        Uri.parse('https://62c5-45-243-241-52.ngrok-free.app/restart'), // Restart endpoint
      );
